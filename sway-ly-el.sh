...
echo "Instalando Sway e Wayland..."
# Instala pacotes essenciais para capturas de tela e outras utilidades
pacman -S --noconfirm grim slurp wl-clipboard wofi picom dunst geany swayidle swaylock numlockx
...
pacman -S --noconfirm webp-pixbuf-loader galculator dunst volumeicon alsa-utils alsa-plugins gpicview gvfs gvfs-mtp gvfs-smb gvfs-gphoto2 gvfs-afc tumbler ffmpegthumbnailer cdrtools p7zip unrar unzip zip poppler-glib libgsf libgepub libopenraw freetype2 xarchiver vlc archlinux-wallpaper fastfetch zathura zathura-pdf-mupdf geany geany-plugins telegram-desktop playerctl brightnessctl
...
echo "Instalação e configuração inicial do Sway e Ly (Display Manager) concluída!"
